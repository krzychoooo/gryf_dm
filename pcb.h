...
#define USARTE0_DE_DIR USARTD0_DE_PORT.DIR
#define USARTE0_DE_ODBIERANIE (USARTD0_DE_PORT.OUTCLR |= 1<<USARTD0_DE_PIN)
#define USARTE0_DE_NADAWANIE (USARTD0_DE_PORT.OUTSET |= 1<<USARTD0_DE_PIN)
